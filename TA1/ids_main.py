...
# Configuration
INTERFACE = "\\Device\\NPF_{BCC4F26B-9AD2-45A7-BC2B-58DEF89CE188}"  # Replace with your network interface
ENABLE_LOGGING = True
LOG_FILE = "./ids_alerts.log"

# Telegram Bot Configuration
TELEGRAM_BOT_TOKEN = "your_telegram_bot_token"  # Replace with your bot's API Token
TELEGRAM_CHAT_ID = "your_chat_id"  # Replace with your chat ID (or group)
